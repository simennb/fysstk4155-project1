...
For the OLS and Ridge regression cases, it is possible to derive the variance of $\beta$ \cite{vanwieringen2020lecture}, and thus the confidence intervals as well. For the OLS method, the variance is given by
\begin{align*}
